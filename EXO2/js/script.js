...
function verif() { 
	...
	document.x1y1.style.backgroundImage = "url('img/transparent.png')"; 
	document.x2y1.style.backgroundImage = "url('img/transparent.png')";
	document.x3y1.style.backgroundImage = "url('img/transparent.png')";}
	if (x1y1 == 1 && x2y2 == 1 && x3y3 == 1) { gagnant = 1 ;  
	document.x1y1.style.backgroundImage = "url('img/transparent.png')"; 
	document.x2y2.style.backgroundImage = "url('img/transparent.png')";
	document.x3y3.style.backgroundImage = "url('img/transparent.png')";}
	if (x1y1 == 1 && x1y2 == 1 && x1y3 == 1) { gagnant = 1 ;  
	document.x1y1.style.backgroundImage = "url('img/transparent.png')"; 
	document.x1y2.style.backgroundImage = "url('img/transparent.png')";
	document.x1y3.style.backgroundImage = "url('img/transparent.png')";}
	if (x1y2 == 1 && x2y2 == 1 && x3y2 == 1) { gagnant = 1 ;  
	document.x1y2.style.backgroundImage = "url('img/transparent.png')"; 
	document.x2y2.style.backgroundImage = "url('img/transparent.png')";
	document.x3y2.style.backgroundImage = "url('img/transparent.png')";}
	if (x2y1 == 1 && x2y2 == 1 && x2y3 == 1) { gagnant = 1 ;  
	document.x2y1.style.backgroundImage = "url('img/transparent.png')"; 
	document.x2y2.style.backgroundImage = "url('img/transparent.png')";
	document.x2y3.style.backgroundImage = "url('img/transparent.png')";}
